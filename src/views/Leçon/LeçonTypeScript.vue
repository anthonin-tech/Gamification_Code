...
const LS_KEY = 'codequest_typescript_progress'
...
const curriculum: CourseModule[] = CURRICULUM_TYPESCRIPT
...
function resetAllProgress() {
  if (!confirm('Réinitialiser toute ta progression TypeScript ?')) return
  localStorage.removeItem(LS_KEY)
  location.reload()
}
